    ...
    about: {
      ...
      properties: {
        ...
        manufactured_home_sections: {
          type: "string",
          enum: ["single-wide", "double-wide", "triple-wide"],
      ...
      allOf: [
        {
          ...
          then: {
            ...
            error_msg:
              "If the building 'dwelling_unit_type' is 'manufactured_home', you must identify the 'manufactured_home_sections'",
          },
          else: {
            not: {
              required: ["manufactured_home_sections"],
              error_msg:
                "If the building 'dwelling_unit_type' is not 'manufactured_home', the 'manufactured_home_sections' must not be set",
            },
          },
        },
        {
          if: {
            ...
            error_msg:
              "If 'blower_door_test' is true, 'air_sealing_present' must not be set and 'envelope_leakage' must be set",
          },
          then: {
            allOf: [
              {
        ...
        },
        {
          if: {
            ...
            error_msg:
              "If 'blower_door_test' is false, 'air_sealing_present' must be set and 'envelope_leakage' must not be set",
          },
          then: {
            allOf: [
              {
        ...
        },
        {
          if: {
            properties: {
              dwelling_unit_type: {
                enum: ["apartment_unit", "manufactured_home"],
              },
            },
                ...
                allOf: [
                  ...
                  },
                  {
                    if: {
                      ...
                      error_msg:
                        "Skylights of 'Code' type construction must have an assembly code and not custom U values or Solar Heat Gain Coefficients",
                    },
                    then: {
                      allOf: [
                        {
                  ...
                  },
                  {
                    if: {
                      ...
                      required: ["skylight_area", "skylight_method"],
                      error_msg:
                        "Skylights of 'Custom' type construction must have custom U values and Solar Heat Gain Coefficients and not have an assembly code ",
                    },
                    then: {
                      allOf: [
                        {
            ...
            allOf: [
              {
                if: {
                  ...
                  required: ["roof_type"],
                  error_msg:
                    "Roof color and attic roof insulation are required for Vented Attics, Cath Ceiling, Flat Roof, and Bowstring Roof ",
                },
                then: {
              ...
              },
              {
                if: {
                  properties: {
                    roof_type: {
                      enum: ["cath_ceiling", "flat_roof", "bowstring_roof"],
                    },
                  },
                  required: ["roof_type"],
                  error_msg:
                    "Ceiling area and and insulation type are not applicable for Cathedral Ceilings, Flat Roof, and Bowstring Roof ",
                },
                then: {
                  allOf: [
              ...
              },
              {
                if: {
                  ...
                  required: ["roof_type"],
                  error_msg:
                    "Roof area and and ceiling insulation type are not applicable for roof Below Other Unit, ceiling area must be set ",
                },
                then: {
                  allOf: [
                    { not: { required: ["ceiling_assembly_code"] } },
              ...
              },
              {
                if: {
                  ...
                  required: ["roof_type"],
                  error_msg:
                    "Ceiling area and and insulation type must be set for Vented Attic",
                },
                then: {
              ...
              },
              {
                if: {
                  ...
                  required: ["roof_color"],
                  error_msg:
                    "Roof absorptance is required when Roof Color is Cool",
                },
                then: {
              ...
              },
              {
                if: {
                  ...
                  required: ["roof_color"],
                  error_msg:
                    "Roof absorptance is only applicable when Roof Color is Cool",
                },
                then: {
                  not: {
                    required: ["roof_absorptance"],
            ...
            allOf: [
              ...
              },
              {
                if: {
                  ...
                  error_msg:
                    "Identified floors must have a foundation type specified",
                },
                then: {
                  allOf: [
                    {
                    ...
                    },
                    {
                      if: {
                        properties: {
                          foundation_type: {
                            enum: ["slab_on_grade", "above_other_unit"],
                          },
                        },
                        required: ["foundation_type"],
                        error_msg:
                          "Floor assembly code not applicable for slab on grade foundations or foundations located above other unit",
                      },
                      then: {
                    ...
                    },
                    {
                      if: {
                        ...
                        required: ["foundation_type"],
                        error_msg:
                          "Foundation insulation level not applicable for foundations located above other unit or belly and wing",
                      },
                      then: {
            ...
            allOf: [
              {
                if: {
                  ...
                  error_msg:
                    "You must provide wall assembly code for walls adjacent to outside, other heated space, other multifamily buffer space, and other non freezing spac.",
                },
                then: {
              ...
              },
              {
                if: {
                  ...
                  required: ["adjacent_to"],
                  error_msg:
                    "Wall assembly code is not applicable for walls adjacent to other unit.",
                },
                then: {
              ...
              },
              {
                if: {
                  ...
                  required: ["adjacent_to"],
                  error_msg:
                    "zone window is only applicable for wall adjacent to outside and not applicable for others.",
                },
                then: {
        ...
        hvac: {
          ...
          items: {
            ...
            properties: {
              ...
              heating: {
                ...
                properties: {
                  ...
                  efficiency: {
                    type: "number",
                    $comment:
                      "Additional requirements for this property apply based on the heating system type",
                  },
                  efficiency_unit: {
                    type: "string",
                    ...
                    then: {
                      ...
                      then: {
                        properties: {
                          efficiency_unit: {
                            description:
                              "Unit of efficiency value (only used if efficiency_method is user)",
                          },
                          efficiency: {
                            description:
                              "Efficiency of heating equipment (only used if efficiency_method is user)",
                          },
                        },
                      },
                      else: {
                        properties: {
                          ...
                          efficiency: {
                            ...
                            maximum: 1,
                            description:
                              "AFUE of heating equipment (only used if efficiency_method is user)",
                          },
                        },
                      },
                    },
                    ...
                    then: {
                      properties: {
                        ...
                        efficiency: {
                          ...
                          maximum: 20,
                          description:
                            "HSPF or HSPF2 of heating equipment (only used if efficiency_method is user)",
                        },
                      },
                    },
                  },
                    ...
                    then: {
                      properties: {
                        ...
                        efficiency: {
                          ...
                          maximum: 5,
                          description:
                            "COP (ARI-330) of heating equipment (only used if efficiency_method is user)",
                        },
                      },
                    },
                  },
              ...
              cooling: {
                ...
                properties: {
                  ...
                  efficiency: {
                    type: "number",
                    $comment:
                      "Additional requirements for this property apply based on the cooling system type",
                  },
                  efficiency_unit: {
                    type: "string",
                    ...
                    then: {
                      properties: {
                        ...
                        efficiency: {
                          ...
                          maximum: 40,
                          description:
                            "SEER or SEER2 of cooling equipment (only used if efficiency_method is user)",
                        },
                      },
                    },
                  },
                    ...
                    then: {
                      properties: {
                        ...
                        efficiency: {
                          ...
                          maximum: 40,
                          description:
                            "EER or CEER of cooling equipment (only used if efficiency_method is user)",
                        },
                      },
                    },
                  },
                    ...
                    then: {
                      properties: {
                        ...
                        efficiency: {
                          ...
                          maximum: 40,
                          description:
                            "EER of cooling equipment (only used if efficiency_method is user)",
                        },
                      },
                    },
                  },
                  {
                    ...
                    then: {
                      properties: {
                        ...
                        efficiency: {
                          description:
                            "Efficiency of cooling equipment (only used if efficiency_method is user)",
                        },
                      },
                    },
                  },
              ...
              hvac_distribution: {
                $comment:
                  "Additional requirements for this property apply based on the heating and cooling system type",
            ...
            allOf: [
              ...
              },
              {
                if: {
                  ...
                  error_msg:
                    "All havc with hvac fraction not 0 require a heating type.",
                },
                then: {
                  properties: {
                    heating: {
              ...
              },
              {
                if: {
                  ...
                  error_msg:
                    "All havc with hvac fraction not 0 require a cooling type.",
                },
                then: {
                  properties: {
                    cooling: {
              ...
              },
              {
                if: {
                  ...
                  error_msg:
                    "cooling type not none or dec require a efficiency method",
                },
                then: {
                  properties: {
                    cooling: {
              ...
              },
              {
                if: {
                  ...
                  required: ["heating"],
                  error_msg:
                    'cooling type must be one of "packaged_dx", "heat_pump", "dec", or "none" for heating type "heat_pump"',
                },
                then: {
                  properties: {
                    cooling: {
              ...
              },
              {
                if: {
                  ...
                  required: ["heating"],
                  error_msg:
                    'cooling type must be one of "packaged_dx", "gchp", "dec", or "none" for heating type "gchp"',
                },
                then: {
                  properties: {
                    cooling: {
              ...
              },
              {
                if: {
                  ...
                  required: ["heating"],
                  error_msg:
                    'cooling type must be one of "packaged_dx", "mini_split", "dec", or "none" for heating type "mini_split"',
                },
                then: {
                  properties: {
                    cooling: {
              ...
              },
              {
                if: {
                  ...
                  required: ["cooling"],
                  error_msg:
                    'heating type must be one of "central_furnace", "wall_furnace", "baseboard", "boiler", "wood_stove", or "none" for cooling type "split_dx"',
                },
                then: {
                  properties: {
                    heating: {
              ...
              },
              {
                if: {
                  ...
                  required: ["cooling"],
                  error_msg:
                    'heating type must be one of "heat_pump", "wood_stove", or "none" for cooling type "heat_pump"',
                },
                then: {
                  properties: {
                    heating: {
              ...
              },
              {
                if: {
                  ...
                  required: ["cooling"],
                  error_msg:
                    'heating type must be one of "gchp", "wood_stove", or "none" for cooling type "gchp"',
                },
                then: {
                  properties: {
                    heating: {
              ...
              },
              {
                if: {
                  ...
                  required: ["cooling"],
                  error_msg:
                    'heating type must be one of "central_furnace", "wall_furnace", "baseboard", "boiler","mini_split", "wood_stove", or "none" for cooling type "mini_split"',
                },
                then: {
                  properties: {
                    heating: {
          ...
          then: {
            properties: {
              hvac: {
                ...
                error_msg:
                  'The category element can only be set to "combined" if the heating/type is "boiler" and the boiler provides the domestic hot water',
              },
            },
          },
        },
          ...
          systems: {
            properties: {
              hvac: {
                ...
                error_msg:
                  'duct/location["uncond_attic"] is not allowed as there is no attic.',
              },
            },
          },
        },
      ...
      if: {
        properties: {
          about: {
            properties: {
              dwelling_unit_type: {
                enum: ["single_family_detached", "manufactured_home"],
              },
            },
            required: ["dwelling_unit_type"],
          },
          ...
          zone: {
            properties: {
              zone_wall: {
                ...
                error_msg:
                  'single family detached and manufactured homes only allow adjacent_to "outside"',
              },
            },
          },
        },
          ...
          systems: {
            properties: {
              hvac: {
                ...
                error_msg:
                  'duct/location["vented_crawl"] is not allowed as there is no vented crawlspace.',
              },
            },
          },
        },
          ...
          systems: {
            properties: {
              hvac: {
                ...
                error_msg:
                  'duct/location["unvented_crawl"] is not allowed as there is no unvented crawlspace.',
              },
            },
          },
        },
          ...
          systems: {
            properties: {
              hvac: {
                ...
                error_msg:
                  'duct/location["uncond_basement"] is not allowed as there is no unconditioned basement.',
              },
            },
          },
        },
          ...
          systems: {
            properties: {
              hvac: {
                ...
                error_msg:
                  'duct/location["manufactured_home_belly"] is not allowed as there is no belly_and_wing foundation type.',
              },
            },
          },
        },

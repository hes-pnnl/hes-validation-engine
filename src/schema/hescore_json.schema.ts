import JSONSchema from './_base.schema.json';
...
(JSONSchema.properties.address.properties.state as any).enum = [
 ...
 */
(JSONSchema.properties.about.properties.assessment_type as any).enum = [
    "initial",
    "final",
    "qa",
    "alternative",
